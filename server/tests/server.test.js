...
describe('GET /todos/:id', () => {
    ...
    it('shouldn\'t return another person\' todo', (done) => {
        request(app)
...
describe('DELETE /todos/:id', () => {
    ...
    it('shouldn\'t remove another user\'s todo', (done) => {
...
describe('PATCH /todos/:id', () => {
    ...
    it('shouldn\'t update someone else\'s the todo', (done) => {
        var id = todos[1]._id.toHexString();
        var actual_text = todos[1].text;
        var text = 'cool';
        var completed = false;
        request(app)
          .patch(`/todos/${id}`)
          ...
          .expect((res) => {
            ...
            Todo.findById(id).then((todo) => {
                expect(todo.completedAt).toBe(333).toBeA('number');
                expect(todo.completed).toBe(true);
                expect(todo.text).toBe(actual_text);
                done();
            }).catch((e) => done(e));
          });
    });
...
describe('DELETE /users/me/token', () =>{
    ...
    it('should return 401 if invalid auth token', (done) => {
        request(app)
        .delete('/users/me/token')
